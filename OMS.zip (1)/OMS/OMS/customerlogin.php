...
if(isset($_POST['username'])){
	...
	$sql = 'SELECT * FROM customer WHERE username="'.$_POST['username'].'" and password="'.$_POST['password'].'" and status = 1';
...
<div class="container-fluid">
	<div class="row" style="padding-top:20px; ">
		<div class="col-lg-4 col-sm-12 offset-lg-4 card bg-dark">
			<h3 class="display-4 text-center text-warning">Customer Login</h3>
		</div>
	</div>
	<div class="row">
